...
public abstract class FromOneDotRightTop extends FromOneDot{
    Point currentPoint = new Point(1280 - 1280 / 12, -50);
    double firstX = 1280 - 1280 / 12;
    int dist = 1280 / 12;
    int height = 100;
    boolean goDown = true;
    boolean for1 = false;
